...
export const CRYPTO_WITHDRAWAL_FILTER_FIELDS: FilterField[] = [
  {
    key: 'id',
    label: 'Withdrawal ID',
    type: 'text',
...
export const QUERY_KEYS = {
  CRYPTO_WITHDRAWAL_LIST: 'crypto-withdrawal',
  CRYPTO_WITHDRAWAL_DETAIL: 'crypto-withdrawal-detail',
} as const

export const TABLE_CONFIG = {
  ID: 'crypto-withdrawal-table',
  EXPORT_FILE_NAME: 'crypto-withdrawals.xlsx',
...
/**
 * Maps crypto withdrawal status to badge variant
 * @param status - Crypto withdrawal status string
